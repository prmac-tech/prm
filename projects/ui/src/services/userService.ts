...
import type { User } from '../data/userApiClient'
import ManageUsersApiClient from '../data/userApiClient'
...
export default class UserService {
  ...
  async getUser(token: string): Promise<UserDetails> {
    ...
    return { ...user, roles: this.getUserRoles(token), displayName: user.name! }
  }
